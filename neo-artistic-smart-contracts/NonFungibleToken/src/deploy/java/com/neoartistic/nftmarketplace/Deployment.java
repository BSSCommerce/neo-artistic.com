...
public class Deployment {
    ...
    private static final String NEOARTISTIC_WIF = "L2ne1nFZLkCNtXhUw4LmgyFyu7hWLZKqpxWmZMmsSiMvTq3agXeu";
    private static final String NODE = "http://seed1t4.neo.org:20332";

    public static void main(String[] args) throws Throwable {
        Neow3j neow3j = Neow3j.build(new HttpService(NODE));

        Account deploymentAccount = Account.fromWIF(NEOARTISTIC_WIF);
        ...
        substitutions.put("${placeholder}", "BSS NFT Market Contract");
    ...
    private static Hash160 deployHelloWorldSmartContract(AccountSigner signer, Hash160 owner,
        ...
        CompilationUnit res = new Compiler().compile(NonFungibleTokenContract.class.getCanonicalName(), substitutions);

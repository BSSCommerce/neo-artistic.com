...
public class Deployment {
    ...
    private static final String ALICE_WIF = "L4bRHTVgxhBFvRFcSCGzvWbFjsAn8hJD98PTPyvqNG7qEQGc66w9";
    ...
    private static Hash160 deployHelloWorldSmartContract(AccountSigner signer, Hash160 owner,
        ...
        CompilationUnit res = new Compiler().compile(ProviderManagerContract.class.getCanonicalName(), substitutions);

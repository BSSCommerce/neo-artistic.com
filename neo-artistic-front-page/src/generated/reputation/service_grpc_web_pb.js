 ...
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.neo.fs.v2.reputation.AnnounceLocalTrustResponse)}
 ...
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.neo.fs.v2.reputation.AnnounceIntermediateResultResponse)}
 *     callback The callback function(error, response)

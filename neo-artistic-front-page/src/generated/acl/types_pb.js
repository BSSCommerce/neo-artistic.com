 ...
 * @return {!proto.neo.fs.v2.acl.EACLRecord.Filter} returns this
 */
 ...
 * @return {!proto.neo.fs.v2.acl.EACLRecord.Target} returns this
 */
 ...
 * @return {!proto.neo.fs.v2.acl.EACLRecord} returns this
 */
 ...
 * @return {!proto.neo.fs.v2.acl.EACLTable} returns this
*/
...
/**
 * @param {number} value
 * @return {!proto.neo.fs.v2.acl.BearerToken.Body.TokenLifetime} returns this
 */
 ...
 * @return {!proto.neo.fs.v2.acl.BearerToken.Body} returns this
*/
...
proto.neo.fs.v2.acl.BearerToken.Body.prototype.clearEaclTable = function() {
  return this.setEaclTable(undefined);
};
 ...
 * @return {!proto.neo.fs.v2.acl.BearerToken} returns this
*/

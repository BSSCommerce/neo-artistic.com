 ...
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.neo.fs.v2.netmap.LocalNodeInfoResponse)}
 ...
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.neo.fs.v2.netmap.NetworkInfoResponse)}
 *     callback The callback function(error, response)

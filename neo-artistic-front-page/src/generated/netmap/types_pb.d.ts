...
export class PlacementPolicy extends jspb.Message {
  ...
  hasSubnetId(): boolean;
  clearSubnetId(): void;
  getSubnetId(): refs_types_pb.SubnetID | undefined;
  setSubnetId(value?: refs_types_pb.SubnetID): void;
...
export namespace PlacementPolicy {
  export type AsObject = {
    ...
    filtersList: Array<Filter.AsObject>,
    subnetId?: refs_types_pb.SubnetID.AsObject,
  }
}
...
export class NetworkConfig extends jspb.Message {
  ...
  getParametersList(): Array<NetworkConfig.Parameter>;
  setParametersList(value: Array<NetworkConfig.Parameter>): void;
  addParameters(value?: NetworkConfig.Parameter, index?: number): NetworkConfig.Parameter;
...
export namespace NetworkConfig {
  export type AsObject = {
    parametersList: Array<NetworkConfig.Parameter.AsObject>,
  }
...
export class NetworkInfo extends jspb.Message {
  ...
  getMsPerBlock(): number;
  setMsPerBlock(value: number): void;

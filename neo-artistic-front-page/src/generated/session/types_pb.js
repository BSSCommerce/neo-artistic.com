...
var status_types_pb = require('../status/types_pb.js');
goog.object.extend(proto, status_types_pb);
...
goog.exportSymbol('proto.neo.fs.v2.session.SessionToken.Body.ContextCase', null, global);
 ...
 * @return {!proto.neo.fs.v2.session.ObjectSessionContext} returns this
 */
...
proto.neo.fs.v2.session.ContainerSessionContext.toObject = function(includeInstance, msg) {
  var f, obj = {
    verb: jspb.Message.getFieldWithDefault(msg, 1, 0),
    wildcard: jspb.Message.getBooleanFieldWithDefault(msg, 2, false),
 ...
 * @return {!proto.neo.fs.v2.session.ContainerSessionContext} returns this
 */
...
/**
 * @param {number} value
 * @return {!proto.neo.fs.v2.session.SessionToken.Body.TokenLifetime} returns this
 */
 ...
 * @return {!proto.neo.fs.v2.session.SessionToken.Body} returns this
 */
...
proto.neo.fs.v2.session.SessionToken.Body.prototype.setObject = function(value) {
  return jspb.Message.setOneofWrapperField(this, 5, proto.neo.fs.v2.session.SessionToken.Body.oneofGroups_[0], value);
};
...
proto.neo.fs.v2.session.SessionToken.Body.prototype.setContainer = function(value) {
  return jspb.Message.setOneofWrapperField(this, 6, proto.neo.fs.v2.session.SessionToken.Body.oneofGroups_[0], value);
};
 ...
 * @return {!proto.neo.fs.v2.session.SessionToken} returns this
*/
...
/**
 * @param {string} value
 * @return {!proto.neo.fs.v2.session.XHeader} returns this
 */
 ...
 * @return {!proto.neo.fs.v2.session.RequestMetaHeader} returns this
*/
...
proto.neo.fs.v2.session.RequestMetaHeader.prototype.clearBearerToken = function() {
  return this.setBearerToken(undefined);
};
...
/**
 * optional uint64 magic_number = 8;
 * @return {number}
 */
proto.neo.fs.v2.session.RequestMetaHeader.prototype.getMagicNumber = function() {
 ...
 * @return {!proto.neo.fs.v2.session.RequestMetaHeader} returns this
 */
proto.neo.fs.v2.session.RequestMetaHeader.prototype.setMagicNumber = function(value) {
...
proto.neo.fs.v2.session.ResponseMetaHeader.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    status: (f = msg.getStatus()) && status_types_pb.Status.toObject(includeInstance, f)
  };
...
proto.neo.fs.v2.session.ResponseMetaHeader.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 5:
      ...
      break;
    case 6:
      var value = new status_types_pb.Status;
      reader.readMessage(value,status_types_pb.Status.deserializeBinaryFromReader);
      msg.setStatus(value);
      break;
    default:
      reader.skipField();
...
proto.neo.fs.v2.session.ResponseMetaHeader.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      6,
      f,
      status_types_pb.Status.serializeBinaryToWriter
    );
  }
};
...
/**
 * @param {?proto.neo.fs.v2.refs.Version|undefined} value
 * @return {!proto.neo.fs.v2.session.ResponseMetaHeader} returns this
*/
...
/**
 * optional neo.fs.v2.status.Status status = 6;
 * @return {?proto.neo.fs.v2.status.Status}
 */
proto.neo.fs.v2.session.ResponseMetaHeader.prototype.getStatus = function() {
  return /** @type{?proto.neo.fs.v2.status.Status} */ (
    jspb.Message.getWrapperField(this, status_types_pb.Status, 6));
};


/**
 * @param {?proto.neo.fs.v2.status.Status|undefined} value
 * @return {!proto.neo.fs.v2.session.ResponseMetaHeader} returns this
*/
proto.neo.fs.v2.session.ResponseMetaHeader.prototype.setStatus = function(value) {
  return jspb.Message.setWrapperField(this, 6, value);
};
 ...
 * @return {!proto.neo.fs.v2.session.ResponseMetaHeader} returns this
 */
proto.neo.fs.v2.session.ResponseMetaHeader.prototype.clearStatus = function() {
 ...
 * @return {boolean}
 */
proto.neo.fs.v2.session.ResponseMetaHeader.prototype.hasStatus = function() {
  return jspb.Message.getField(this, 6) != null;
};
...
/**
 * @param {?proto.neo.fs.v2.refs.Signature|undefined} value
 * @return {!proto.neo.fs.v2.session.RequestVerificationHeader} returns this
*/
...
proto.neo.fs.v2.session.RequestVerificationHeader.prototype.clearBodySignature = function() {
  return this.setBodySignature(undefined);
};
...
proto.neo.fs.v2.session.RequestVerificationHeader.prototype.clearMetaSignature = function() {
  return this.setMetaSignature(undefined);
};
...
proto.neo.fs.v2.session.RequestVerificationHeader.prototype.clearOriginSignature = function() {
  return this.setOriginSignature(undefined);
};
...
/**
 * @param {?proto.neo.fs.v2.refs.Signature|undefined} value
 * @return {!proto.neo.fs.v2.session.ResponseVerificationHeader} returns this
*/

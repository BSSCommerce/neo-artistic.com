...
import * as status_types_pb from "../status/types_pb";
...
export class ResponseMetaHeader extends jspb.Message {
  ...
  hasStatus(): boolean;
  clearStatus(): void;
  getStatus(): status_types_pb.Status | undefined;
  setStatus(value?: status_types_pb.Status): void;
...
export namespace ResponseMetaHeader {
  export type AsObject = {
    ...
    status?: status_types_pb.Status.AsObject,
  }
}
